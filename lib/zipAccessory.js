...
class ZipAccessory{
  ...
  */
  ...
  //
  // /*
  // fixConfigAfterCache compare some parameters to update it for cached accessories
  // */
  // fixConfigAfterCache(config){
  //     /* DEBUG */
  //     this.debug && this.log("[ZIPAC] > Method fixConfig", this.debugContext);
  //     if(config["debug"] != this.debug){
  //       this.debug = config["debug"];
  //       this.debug && this.log("[ZIPAC] [fixConfig] debug change to",this.debug, this.debugContext")
  //     }
  //     /* noStatus */
  //     if((config["noStatus"] || false) != this.noStatus){
  //       this.noStatus = config["noStatus"] || false;
  //       this.noStatus && this.log("[ZIPAC] [fixConfig] noStatus change to",this.noStatus, this.debugContext")
  //     }
  //     /* reverseValue */
  //     if((config["reverse"] || false) != this.reverseValue){
  //       this.reverseValue = config["reverse"] || false;
  //       this.reverseValue && this.log("[ZIPAC] [fixConfig] reverse change to",this.reverseValue, this.debugContext")
  //     }
  //     /* nightMode */
  //     if((config["nightMode"] || false) != this.nightMode){
  //       this.nightMode = config["nightMode"] || false;
  //       this.nightMode && this.log("[ZIPAC] [fixConfig] nightMode change to",this.nightMode, this.debugContext")
  //     }
  //     /* manufacturer */
  //     if((config["manufacturer"] || "zipato") != this.manufacturer){
  //       this.manufacturer = config["manufacturer"] || "zipato";
  //       this.manufacturer && this.log("[ZIPAC] [fixConfig] manufacturer change to",this.manufacturer, this.debugContext")
  //     }
  //     /* manufacturer */
  //     if((config["model"] || "zipato") != this.model){
  //       this.model = config["model"] || "zipato";
  //       this.model && this.log("[ZIPAC] [fixConfig] model change to",this.model, this.debugContext")
  //     }
  //     /* serial */
  //     if((config["serial"] || "zipato") != this.serial){
  //       this.serial = config["serial"] || "zipato";
  //       this.serial && this.log("[ZIPAC] [fixConfig] serial change to",this.serial, this.debugContext")
  //     }
  //     /* min */
  //     if((config["min"] || 0) != this.min){
  //       this.min = config["min"] || 0;
  //       if(typeof(this.min) == "string")
  //         this.min = parseInt(this.min);
  //       this.min && this.log("[ZIPAC] [fixConfig] min change to",this.min, this.debugContext")
  //     }
  //     /* max */
  //     if((config["max"] || 0) != this.max){
  //       this.max = config["max"] || 0;
  //       if(typeof(this.max) == "string")
  //         this.max = parseInt(this.max);
  //       this.max && this.log("[ZIPAC] [fixConfig] max change to",this.max, this.debugContext")
  //     }
  //     this.range = this.max-this.min;
  //     /* batteryLimit */
  //     if((config["batteryLimit"] || 0) != this.batteryLimit){
  //       this.batteryLimit = config["batteryLimit"] || 0;
  //       this.batteryLimit && this.log("[ZIPAC] [fixConfig] batteryLimit change to",this.batteryLimit, this.debugContext")
  //     }
  //     /* timePolling */
  //     if((config["refresh"] || 0) != this.timePolling){
  //       this.timePolling = config["refresh"] || 0;
  //       this.timePolling && this.log("[ZIPAC] [fixConfig] batteryLimit change to",this.timePolling, this.debugContext")
  //     }
  // }
