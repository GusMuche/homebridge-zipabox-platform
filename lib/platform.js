...
class ZipaPlatform{
  ...
  constructor (log, config, homeBridgeApi) {
    ...
    if(this.IP == "remote"){
      ...
      if(this.IP == "remoteV3"){
        ...
        this.log.warn("[PTFM] V3 API is only partially tested. Be aware of this")
    ...
    .then(function firstRefreshOfAccessories(notUsedReturn){
      ...
      for (var zipAccesory of this.zipAccessories){
        ...
        if(this.centralRefresh){
          ...
          this.attributesValues[zipAccesory.getUUID] = null;
        }
      }
    }.bind(this))
        ...
        .then(function updateDevicesStatus(newDevicesStatuses){
          ...
          for (var zipAccesory of this.zipAccessories){
            ...
            if(status != null){
              ...
              this.debug && this.log("[PTFM] [statusPolling] Big Refresh. Device ",zipAccesory.getDeviceUUIDfix(), "status", status, zipAccesory.getDebugContext());
            }
          }
        }.bind(this))
        ...
        .then(function updateAttributesValues(newAttributesValues){
          ...
          for (var zipAccesory of this.zipAccessories){
            ...
            if(value != null){
              ...
              zipAccesory.updatePolling();
              this.debug && this.log("[PTFM] [statusPolling] Big Refresh. Attributes ",zipAccesory.getZipaUUID(), "value", value, zipAccesory.getDebugContext());
            }
          }
        }.bind(this))
        .catch(function manageError(error){
  ...
  */
  getNewAttributeValue(attributesValues,attributeUUID,noStatus){
    /* DEBUG */
  ...
  */
  getNewDeviceStatus(devicesStatuses,deviceUUID){
    /* DEBUG */
