  ...
  checkDoubleConfig(){
    ...
    for(var indexSearch in this.accessoriesConfig){
      for(var indexCheck in this.accessoriesConfig){
        this.log("DEBUG : indeSearch and indexCheck : " + indexSearch + " - " + indexCheck);
        this.log("DEBUG : UUID : " + this.accessoriesConfig[indexSearch].UUID + " - " + this.accessoriesConfig[indexCheck].UUID);
        if(this.accessoriesConfig[indexSearch].UUID == this.accessoriesConfig[indexCheck].UUID && indexSearch != indexCheck)
          this.log('WARNING : same UUID for different accessories, please check config.json.')
      }
    }
  }
