        ...
        .then(function updateDevicesStatus(newDevicesStatuses){
          ...
          for (var zipAccesory of this.zipAccessories){
            ...
            if(status != null){
              ...
              this.debug && this.log("[PTFM] [statusPolling] Big Refresh. Device ",zipAccesory.getDeviceUUIDfix(), "status", status);
            }
          }
        }.bind(this))
        ...
        .then(function updateAttributesValues(newAttributesValues){
          ...
          for (var zipAccesory of this.zipAccessories){
            ...
            if(value != null){
              ...
              zipAccesory.updatePolling();
              this.debug && this.log("[PTFM] [statusPolling] Big Refresh. Attributes ",zipAccesory.getZipaUUID(), "value", value);
            }
          }
        }.bind(this))
        .catch(function manageError(error){
