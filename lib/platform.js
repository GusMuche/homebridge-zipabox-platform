...
class ZipaPlatform{
  ...
  */
  configureAccessory(accessory){
    ...
    if(this.reset){
      this.debug && this.log("Plugin delete the cached accessory ", accessory.displayName)
      this.accessories = [];
  ...
  */
  ...
  removeAccessory(accessory){
    ...
    var indexIfStored = this.isAccessoryStored(accessory.UUID)
    if(indexIfStored != -1)
      this.accessories.delete(indexOfStored);
  }
