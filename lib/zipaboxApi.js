...
class ZipaboxApi{
  ...
  */
  connectUser(){
    /* DEBUG */
    this.debug && this.log(">>> Method connectBox()");

    return this.initUser()
    .then(this.loginUser.bind(this));
  ...
  */
  ...
  /*
  Same as initSecurity but only for the first connection.
  PIN will then be saved inside the zipaboxApi Object
  */
  initFirstSecurity(pin){
    this.pin = pin;
  ...
  putSecuritySystem(uuidPartition,valueInt){
    ...
    */
    return new Promise(function(resolve,reject){
      ...
      .catch(function manageError(error) {
        console.log.error('Error occurred!', error);// TODO ADD gestion Error
        reject(error);
      });// end fetch chaining
    }.bind(this)); // end Promise
  ...
  */
  putAttributesValueRequest(uuid,valueBool){
    return new Promise(function(resolve, reject){
      ...
      .catch(function manageError(error) {
        console.log('Error occurred on putAttributesValueRequest :', error);// TODO ADD gestion Error
        reject(error);
      });// end fetch chaining
    }.bind(this));// End Promise
