...
/* testJSON check a string to see if it's a json or not */
function testJSON(text){
  // if (typeof text !== "string" && typeof text !== "object") {
  //   console.log("return false cause Json is not an string or Object");
  //   return false;
  // }
  try {
    JSON.parse(text);
