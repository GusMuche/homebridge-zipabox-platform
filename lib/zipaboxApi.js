...
class ZipaboxApi{
  ...
  */
  ...
  /*
  connectSecurity will calculate the token to connect to the partition
    ...
    return new Promise(function(resolve,reject){
      ...
      .then(function giveResult(jsonReponse){
        ...
        if(jsonReponse.response.success == false)
          this.log.error("Connection to the connectSecurity : ",jsonReponse.response.success); // TODO manage error if false
        else
