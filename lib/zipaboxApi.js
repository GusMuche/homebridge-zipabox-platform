...
class ZipaboxApi{
  ...
  Return a promise with resolve true after connection, false if error
  */
  connectUser(){
  ...
  */
  ...
  V3 : /attributes/full (GET)
  V1-V2 : /attributes (GET)
  */
  getAllAttributes(){
    /* DEBUG*/
  ...
  /*
  Method getAllAttributesValues get all the values for all the attributes as an dictionnary
  */
  getAllAttributesValues(){
    /* DEBUG */
    this.debug && this.log("[BOXAPI] > Methode getAllAttributesValues()");
    var extraUrl = 'attributes/values';
    return new Promise(function(resolve,reject){
      fetch(this.baseURL + extraUrl, myInitGet)
      .then(this.fstatus.bind(this))
      .then(fjson)
      .then(function returnArrayOfAllUUIDValues(jsonResponse){
        //this.debugFull && this.log("[BOXAPI] [getAllAttributesValues] jsonResponse of getAllAttributesValues :", jsonResponse);
        resolve(jsonResponse);
      }.bind(this))
      .catch(function manageError(error) {
        this.debugFull && this.log("[BOXAPI] [getAllAttributesValues] Error after fetch :", jsonResponse);
        reject(error);
      }.bind(this));// end fetch chaining
    }.bind(this)); // end promise
  } // end getAllAttributesValues
  ...
  */
      ...
      return new Promise(function(resolve, reject) {
        ...
        .catch(function manageError(error) {
          if(error.message == "No JSON" || error.type == 'invalid-json'){
            this.debug && this.log("[BOXAPI] [getDeviceStatus] Invalid JSON manage to force true - Thanks V3. Throw error");
            reject(error);
          }else{
  ...
  /*
  getAllDevicesStatuses return an array with all the statuses of the devices
  */
  getAllDevicesStatuses(){
    /* DEBUG */
    this.debug && this.log("[BOXAPI] > Methode getAllDevicesStatuses()");

    return new Promise(function(resolve, reject) {
      fetch(this.baseURL + 'devices/statuses',myInitGet)
      .then(this.fstatus.bind(this))
      .then(fjson)
      .then(function returnAllDeviceStatus(jsonResponse){
        //this.debugFull && this.log("[BOXAPI] [getAllDevicesStatuses] jsonResponse :", jsonResponse);
        resolve(jsonResponse);
      }.bind(this))
      .catch(function manageError(error) {
        this.debugFull && this.log("[BOXAPI] [getAllDevicesStatuses] Error after fetch :", jsonResponse);
        reject(error);
      }.bind(this));// end fetch chaining
    }.bind(this));// End Promise
  } // end getAllDevicesStatuses
  ...
  */
  getSecurityStatus(uuidPartition,nightMode){
    ...
    */
    return new Promise(function(resolve,reject){
      ...
      .catch(function manageError(error) {
        this.debug && this.log.error('[BOXAPI] [getSecurityStatus] Error :', error);// TODO ADD gestion Error
        reject(error);
      }.bind(this));// end fetch chaining
    }.bind(this)); // end promise
  ...
  /*
  Return the partition list UUID with name
  */
  getSecurityPartitions(){
    return new Promise(function(resolve,reject){
      /* DEBUG */
      this.debug && this.log("[BOXAPI] > Method getSecurityPartition()");

      /* Fetch request construction */
      fetch(this.baseURL + "alarm/partitions",myInitGet)
      .then(this.fstatus.bind(this))
      .then(fjson)
      .then(function returnArray(jsonResponse){
          resolve(jsonResponse);
      })
      .catch(function manageError(error) {
        console.log('[BOXAPI] [getSecurityPartitions] Error :', error);
        reject(error);
      });// end fetch chaining

    }.bind(this));// End Promise
  } // end getSecurityPartition method
