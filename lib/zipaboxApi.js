...
class ZipaboxApi{
  ...
  */
  getDeviceStatus(uuidDevice,noStatus){ // Return the device Status
    ...
    this.debug && this.log("[BOXAPI] [getDeviceStatus] Parameters : ", uuidDevice, noStatus);
    if(noStatus){ //config say that no device is available > return true
      ...
      return new Promise(function(resolve, reject) {
        ...
        .then(function returnDeviceStatus(jsonResponse){
          ...
          this.debug && this.log("[BOXAPI] [getDeviceStatus] jsonResponse :", jsonResponse);
          //this.debug && this.log("[BOXAPI] [getDeviceStatus] Device status :",jsonResponse.state.online);
        ...
        .catch(function manageError(error) {
          //console.log('[BOXAPI] [getDeviceStatus] Error occurred in getDeviceStatus :', error);// TODO ADD gestion Error
          reject(error);
        });// end fetch chaining
      }.bind(this));// End Promise
    }
  ...
  */
  getAttributesValue(uuidAttributes){ // Just method to maintain the request, not the value (need to be done)
    return new Promise(function(resolve, reject){
      ...
      this.debug && this.log("[BOXAPI] [getAttributesValue] request : ", this.baseURL + 'attributes/' + uuidAttributes + '/value');
  ...
  putSecuritySystem(uuidPartition,valueInt){
    ...
    */
    return new Promise(function(resolve,reject){
      ...
      this.debug && this.log("[BOXAPI] [putSecuritySystem] uuidPartition :",uuidPartition);
      this.debug && this.log("[BOXAPI] [putSecuritySystem] valueInt :",valueInt);
      ...
      //this.debug && this.log("[BOXAPI] [putSecuritySystem] myInitPost:",myInitPost);
      ...
      .then(function giveResponse(jsonResponse){
        this.debug && this.log("[BOXAPI] [putSecuritySystem] Response of POST : ",jsonResponse);
        this.debug && this.log("[BOXAPI] [putSecuritySystem] success of Response :",jsonResponse.success);
        this.debug && this.log("[BOXAPI] [putSecuritySystem] type of success of Response :",typeof(jsonResponse.success));
        this.debug && this.log("[BOXAPI] [putSecuritySystem] zoneStatus of Response :",jsonResponse.zoneStatuses);
  ...
  */
  putAttributesValueRequest(uuid,valueBool){
    return new Promise(function(resolve, reject){
      ...
      this.debug && this.log("[BOXAPI] [putAttributesValueRequest] myInitPut:",myInitPut);
      this.debug && this.log("[BOXAPI] [putAttributesValueRequest] URL:",this.baseURL + 'attributes/' + uuid + '/value');
